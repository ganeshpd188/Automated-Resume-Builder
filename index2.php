...
<body>
	<div id="form_container">
		<form id="resumeform" class="resume" action="studentdatabase.php" method="post">
			...
			<div class="center">
				...
				<h3>Name</h3>
							...
							<input type="text" required="true" name="usn" placeholder="Password" size="50" maxlength="12" value=""/><br>
							<p>Make sure you remember this for further access</p><br>
							<label>Full Name*</label>
							<input type="text" required="true" name="fullname" placeholder="First+Last" size="50" maxlength="60" value=""/><br>
				...
				<h3>Contact Details</h3>
					<label>Mobile No *:</label>
						...
						<input type="number" required="true" name="mobile" placeholder="10 digit Number" size="50" maxlength="10" value=""/><br>
				...
				<li id="markscorner">
					...
					<div class="be">
						...
						<div class="becenter">
							...
							<input type="number" name="sem1" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sem1total" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	
							<Label><b>Sem 2</b></label>
							<input type="number" name="sem2" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sem2total" size="5" placeholder="0 if not known" maxlength="10" value=""/><br><br>
		
							<Label><b>Sem 3</b></label>
							<input type="number" name="sem3" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sem3total" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<Label><b>Sem 4</b></label>
							<input type="number" name="sem4" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
						
						<input type="number" name="sem4total" size="5" placeholder="0 if not known" maxlength="10" value=""/><br><br>
						
							<Label><b>Sem 5</b></label>
							<input type="number" name="sem5" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sem5total" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<Label><b>Sem 6</b></label>
							<input type="number" name="sem6" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sem6total" size="5" placeholder="0 if not known" maxlength="10" value=""/><br><br>
				
							<Label><b>Sem 7</b></label>
							<input type="number" name="sem7" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sem7total" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	
							<Label><b>Sem 8</b></label>
							<input type="number" name="sem8" size="5" placeholder="0 if not known" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
					...
					<div class="becenter">	
							...
							<input type="number" name="sslc" required="true" size="5" maxlength="10" value=""/>&nbsp;&nbsp;&nbsp;<b>Total Marks</b>
							<input type="number" name="sslctotal" required="true" size="5" maxlength="10" value=""/><br><br>
					</div>	
					<div class="data">
							<label>School Name*</label>
							<input type="text" name="school" required="true" size="30" maxlength="250" value=""/>
							...
							<label>Year of Completion</label>
							<input type="number" name="sslcyear" required="true"  size="30" maxlength="4" value=""/><br>
							<p>Year of Completion</p>
						</span>	
					</div>
				</li><br>
				...
				<h3>Personal Details</h3>
					...
					<div class="data">
						...
						<input type="text" name="nationality" required="true"  size="30" maxlength="50" value=""/><br>
						<p>citizen of?</p>
						
						<label>Marital Status</label>
						<input type="text" name="maritalstatus" required="true" size="30" maxlength="50" value=""/><br>
						<p>Single/Married/...</p>
						
						<label>Languages Known</label>
						<input type="text" name="languagesknown" required="true" size="30" maxlength="1000" value=""/><br>
